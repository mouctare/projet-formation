...
const AvailaBilityPage = (props) => {
  ...
  const handleDelete = async (id) => {
    ...
    setAvalabilities(
      availabilities.filter((availabilitie) => availabilitie.id !== id)
    );
  ...
  if (search === "") {
    ...
    filteredAvailabilities = availabilities.filter((a) =>
      a.user.firstName
        .toLowerCase()
        .startsWith(
          search.toLowerCase() ||
      ...
      <table className="table table-hover">
        <thead>
          <tr>
            ...
            <th scope="col">Date de de fin</th>
          ...
          <tbody>
            {paginatedAvailabilities.map((availabilitie) => (
              <tr key={availabilitie.id}>
                <td>
                  <a href="#">
                    {availabilitie.user.firstName} {availabilitie.user.lastName}
                  </a>
                </td>
                <td>{formatDate(availabilitie.startDate)}</td>
                <td>{formatDate(availabilitie.dateEnd)}</td>
                <td>{availabilitie.detail}</td>
                <td>
                  ...
                  <button
                    ...
                    onClick={() => handleDelete(availabilitie)}
                  >
                    Supprimer
                  </button>
                </td>
