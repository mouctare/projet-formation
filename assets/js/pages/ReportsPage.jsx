...
const ReportsPage = () => {
  const [planning, setPlannings] = useState([]);
  ...
  const fetchPlannings = async () => {
    try {
      ...
      // console.log("etat de plannings", plannings);
      console.log("data mapping plannings", data);
      console.log("tableau de planning ", planning);
    } catch (error) {
          ...
          <div className="col-lg-5">
            <div className="card">
              <div className="card-header">
                <Link className="btn btn-primary" to="/rapports/new">
                  Créer un rapport
                </Link>
              </div>
            </div>
            ...
            {paginatedReports.map((report) => (
              <tr key={report.id}>
                ...
                <td className="text-center">
                  <span
                    className={"badge badge-" + TITLE_CLASSES[report.title]}
                  >
                    {report.title}
                  </span>
                </td>
