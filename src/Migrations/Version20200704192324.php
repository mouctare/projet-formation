 ...
 */
final class Version20200704192324 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE planning ADD created_at DATETIME NOT NULL, CHANGE site_id site_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE planning DROP created_at, CHANGE site_id site_id INT DEFAULT NULL');
